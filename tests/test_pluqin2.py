...
class PLUQinRegionsCC(unittest.TestCase):
    ...
    def test_regions_type(self):
        """
        All regions should be type: `shapely.Polygon` or
    ...
    def test_all_available_corr(self):
        """
        Possible correlation for the experiment type and the 20 amino
        acids are in the shapefile except the diagonal (the diagonal
        is not a 2D correlation it is 1D). And any specifically
        listed.
        """
